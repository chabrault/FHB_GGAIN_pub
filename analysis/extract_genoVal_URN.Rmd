...
#dat$GID <- format_names(dat$GID)$corrected
corresp.list <- readRDS(here("code","list_corresp_genotype_name.rds"))
func <- concordance_match_name(match.name=dat$GID, corresp.list=corresp.list)
func$df.changes
dat$GID <- func$new.names
```
