...
## plot heatmap URN FHB
ggplot(cmon.genoYr.URNFHB, aes(x=YEAR1, y=YEAR2, fill=n_common_geno))+
  geom_tile(color="white")+
  geom_text(aes(label=n_common_geno), size=2)+
  paletteer::scale_fill_paletteer_c("grDevices::ag_Sunset") +
  theme_bigstatsr(size.rel=0.8)+
...
## plot heatmap URSN
ggplot(cmon.genoYr.URSN, aes(x=YEAR1, y=YEAR2, fill=n_common_geno))+
