...
#'
#' @examples
format_curate_vcf <- function(vcf.p2f=NULL, matrix.gt=NULL, mrk.info=NULL,
                              corresp.geno.name=NULL,
                              p2f.export.vcf=NULL,IDnum=FALSE,
                              remove.chrUkn=TRUE, check.mrk.dups=TRUE,
                              remove.nonPolyMrk=TRUE, tresh.heterozygous=NULL,
                              check.geno.dups=TRUE, thresh.NA.ind=0.5,
                              thresh.NA.mrk=0.5,format.names=FALSE,
                              concordance.function=FALSE,
                              corresp.geno.list=NULL,
                              imputation=NULL,p2f.beagle=NULL,
...
pal_13envt <- function(){
  return(c("BRK_2018"="#FFEC8B", "BRK_2019"="#FFC125",
           "BRK_2020"="#CD9B1D", "BRK_2021"="#8B6914",  "BRK_2022"="#8B4513",
           "CRK_2019"="#BFEFFF", "CRK_2020"= "#1C86EE",  "CRK_2022"="#104E8B",
           "STP_2018"="#C1FFC1",  "STP_2019"="#ADFF2F",  "STP_2021"="#66CD00",
           "STP_2022"="#228B22",
           ## rep with short names
           "BRK_18"="#99D8C9FF", "BRK_19"="#97E196FF",
           "BRK_20"="#6CC08BFF", "BRK_21"="#4C9B82FF",  "BRK_22"="#217A79FF",
           "CRK_19"="#C6DBEFFF", "CRK_20"= "#1C86EE",  "CRK_22"="#08519CFF",
           "STP_18"="#FEC0BFFF",  "STP_19"="#FEA19EFF","STP_20"="#FD817EFF",  "STP_21"="#BE4A47FF",
           "STP_22"="#7F312FFF"))
}
